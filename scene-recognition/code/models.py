...
class YourModel(tf.keras.Model):
    ...
    def __init__(self):
        ...
        # 120809 version without Dropout and Dense(units=32?)
        self.architecture = [Conv2D(filters=32, kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu'),
       ...
       #  self.architecture = [Conv2D(filters=64, kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu'),
       ...
       #  self.architecture = [Conv2D(filters=8, kernel_size=(3,3), padding='same', strides=(1,1), activation='relu'),
       #                       Conv2D(filters=16, kernel_size=(5,5), padding='same', strides=(2,2), activation='relu'),
       #                       MaxPool2D(pool_size=(2,2)),
       #                      #  Dropout(rate=0.3),
       #                       Conv2D(filters=32, kernel_size=(5,5), padding='same', strides=(2,2), activation='relu'),
       #                       Conv2D(filters=64, kernel_size=(5,5), padding='same', strides=(1,1), activation='relu'),
